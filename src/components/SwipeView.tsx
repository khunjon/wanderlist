  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-95 z-50 flex items-center justify-center">
      ...
      >
              ...
              <div className="flex items-center space-x-3 pt-2">
                ...
                >
                  ...
                  <span className="text-sm">
                    {currentPlace.notes ? 'Notes' : 'Add Notes'}
                  </span>
                </button>
                ...
                {isOwner && (
                  <>
                    <button
                      onClick={() => onEditNotes(currentPlace)}
                      className="p-2 rounded-full bg-black bg-opacity-50 text-gray-300 hover:text-white transition-colors"
                      title="Edit notes"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button
                      onClick={() => onDeletePlace(currentPlace)}
                      disabled={isDeletingThisPlace}
                      className="p-2 rounded-full bg-black bg-opacity-50 text-gray-300 hover:text-red-400 transition-colors disabled:opacity-50"
                  ...
                  {currentPlace.notes ? (
                    ...
                    <div className="text-center py-8">
                      ...
                      {isOwner && (
                        <button
                          onClick={() => onEditNotes(currentPlace)}
                          className="mt-3 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
                        >
                          Add Notes
                        </button>
                      )}
        ...
        {/* Swipe hint */}
        <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 text-white text-xs opacity-50 pointer-events-none">
