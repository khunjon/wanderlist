            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-6">
                ...
                <div className="flex justify-end">
                  <Link
                    href="/lists"
                    className="inline-flex items-center px-4 py-2 border border-gray-600 text-sm font-medium rounded-md text-gray-300 bg-transparent hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                  >
                    Back to My Lists
                  </Link>
                  <button
