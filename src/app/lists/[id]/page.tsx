  ...
  useEffect(() => {
    ...
    const fetchListAndPlaces = async () => {
      try {
        ...
        const placesData = await getPlacesInList(listId);
      ...
      <header className="bg-white shadow">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold tracking-tight text-gray-900">{list.name}</h1>
        ...
        <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
          {places.length > 0 ? (
              ...
              {places.map((place) => (
                ...
                >
                  ...
                  <div className="px-4 py-5 sm:p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-500 line-clamp-2">{place.address}</p>
                    {place.rating > 0 && (
                      <div className="mt-2 flex items-center">
                        <span className="text-sm font-medium text-gray-900">{place.rating.toFixed(1)}</span>
            ...
            <div className="text-center py-12 bg-white shadow rounded-lg">
              ...
              <p className="mt-1 text-sm text-gray-500">Get started by adding places to your list.</p>
              <div className="mt-6">
                <Link
                  href={`/search?listId=${list.id}`}
